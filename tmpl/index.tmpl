  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
    	...
    	<p>Нажимая кнопку "Далее" я подтверждаю своё согласие с <a href="/public/docs/rules.pdf">"Правилами оказания услуг по доступу к сети интернет в гостинице "Три медведя"</a>.</p>

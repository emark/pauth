...
create table routers (id integer primary key auto_increment, parent integer default 0, ip varchar(15), status tinyint(1) default 0, updated datetime, caption char(50));
